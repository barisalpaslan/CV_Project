<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CvProje.WebForm1" %>
        ...
        <div class="banner-text-w3ls" id="home">
            <div class="container">
                <div class="mx-auto text-center">
                    ...
                    <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" href="#about" role="button">Başla</a>
                </div>
            </div>
        </div>
        <!-- about -->
        ...
        <section class="wedo" id="contact">
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    ...
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Gönder" OnClick="Button1_Click"></asp:Button>
                    <asp:Button ID="Button2" runat="server" CssClass="btn btn-danger" Text="Vazgeç"></asp:Button>
